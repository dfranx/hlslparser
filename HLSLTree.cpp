...
{
    m_firstPage         = (NodePage*)m_allocator->New(m_allocator->m_userData, sizeof(NodePage));
...
HLSLTree::~HLSLTree()
{
    ...
    while (page != NULL)
    {
        ...
        m_allocator->Delete(m_allocator, page);
        page = next;
    }
}
...
{
    NodePage* newPage    = (NodePage*)m_allocator->New(m_allocator->m_userData, sizeof(NodePage));
    newPage->next        = NULL;
